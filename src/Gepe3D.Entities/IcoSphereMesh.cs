...
{
    public class IcoSphereMesh : Mesh
    {
        ...
        // initialized to the starting icosahedron
        private List<Vector3i> triangles = new List<Vector3i>()
        {
        ...
        public IcoSphereMesh(float radius, int subdivisions)
        {
            ...
            for (int i = 0; i < vertices.Count; i++)
            {
                ...
                AddVertex( vertices[i].X, vertices[i].Y, vertices[i].Z );
            }
